...
governs all stage work against docs/art/warm-ember-reference.png, and
the art lives as 16 SVG sprites in assets/terrarium/ (generated by
generate.py — rerun after edits). The component only places sprites and
draws the live telemetry layer: banner, eye glows + sleep lids, lamp
cones, candle flames, lock state, chart lines, tags, bubbles, patrol,
packets. Stage golden at goldens/terrarium-stage-warm-ember.png.
